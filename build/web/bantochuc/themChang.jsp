            ...
            <div class="header  ">
                <div class="row bg-light">
                    ...
                    <div class="col-9 align-content-center ">
                        <p style="margin-top: 22px; font-size: x-large;">Thêm chặng đua</p>
                    </div>
                    <div class="col-2">
                       <a href="../">
                    ...
                    <div class="col-5 " >
                        <table class="table table-borderless">
                            ...
                            <tbody>
                                <tr>
                                    <td>Tên chặng: </td>
                                    <td>  <input type="text" name="tenChang" class="chang-input"></td>
                                </tr>

                                <tr>
                                    <td>Vòng đua: </td>
                                    <td>  <input type="text" name ="tenVong" class="chang-input"> </td>
                                </tr>

                                <tr>
                                    <td>Đường đua: </td>
                                    <td> <input type="text"  name="duongDua" >
                                    </td>
                                </tr>
                        ...
                        <table class="table table-borderless">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>Ngày đua: </td>
                                    <td> <input type="date" name="ngayDua" class="chang-input" ></td>
                                </tr>
                                <tr>
                                    <td>Số vòng tối đa: </td>
                                    <td>  <input type="text" name="soVong"class="chang-input" ></td>
                                </tr>
                                <tr>
                                    <td>Chiều dài 1 vòng: </td>
                                    <td>  <input type="text" name="motVong" class="chang-input" > km</td>
                                </tr>
                                <tr>
                                    <td>Ghi chú: </td>
                                    <td>  <input type="text" name="moTa" class="chang-input"></td>
                                </tr>
