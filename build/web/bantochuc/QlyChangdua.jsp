    ...
    <body>
            ...
            <div class="header  ">
                <div class="row bg-light">
                    ...
                    <div class="col-9 align-content-center ">
                        <p style="margin-top: 22px; font-size: x-large;">Quản lý thông tin chặng đua</p>
                    </div>
                    <div class="col-2">
                       <a href="../">
        ...
        <div class="container-fluid" style="margin-top: 150px;">
            <form name ="timChang" action="doTimkiem.jsp" method="post" style="margin-left: 10px;margin-top: 150px;">
                <input name="action" value="suaChang"  type="hidden">
                <p><label>Chọn Giải đua:<label>
                        <select name = "giaidua">
                            <%for (Giaidua gd : dsgiai) {%>
                            <option value="<%=gd.getId()%>"><%=gd.getTen()%></option>
                            <%}%>
                            <input type="text" name="tenchang" id="tenChang" style="width: 300px" <%if (session.getAttribute("timKiem") != null) {%> placeholder="<%= (String)session.getAttribute("timKiem") %>" <%}%>>
                        ...
                        %>
                        <h2> Danh sách chặng đua <%=tenGiai %> </h2>
                        ...
                        <table class=" table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="../bantochuc/suaChang.jsp?index=<%=i%>" >Sửa</a></td>
                                </tr>
                                <%}%>
                            </tbody>
                        </table>
                        <%}else { %>
                        <p>Không tìm thấy chặng có tên tương ứng</p>
                        <%}%>
                        </div>
                         <a href="../bantochuc/themChang.jsp">
                            <button class="btn btn-info">Thêm chặng</button>
                        </a>
